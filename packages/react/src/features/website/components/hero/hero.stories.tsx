...
export const WithContentCenter: StoryObj = {
  render: (args) => (
    <Hero
      {...args}
      style={{
...
export const WithContentVertical: StoryObj = {
  render: (args) => (
...
export const WithBackdropIllustration: StoryObj = {
  render: (args) => (
    <HeroBackdrop>
      <div
        style={{
...
export const WithImages: StoryObj = {
  render: (args) => (
    <Hero {...args}>
      <HeroSection style={{ maxWidth: "var(--spacing-3xl)" }}>
        <VStack>
...
export const WithDiagonalShape: StoryObj = {
  render: (args) => (
    <HeroBackdrop>
      <Hero
        {...args}
