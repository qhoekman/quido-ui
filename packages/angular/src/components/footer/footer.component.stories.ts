        ...
        <div qui-footer-content>
          <div qui-footer-columns>
            <div qui-footer-column class="mt-0">
              <span qui-sr-only>Company name</span>
            ...
            <div qui-footer-column>
              <h3 qui-footer-heading>Company</h3>
              <ul qui-footer-column-list>
                <li qui-footer-column-list-item>
                  <a href="#" qui-footer-link rel="noopener noreferrer" target="_blank">About</a>
                </li>
                <li qui-footer-column-list-item>
                  <a href="#" qui-footer-link rel="noopener noreferrer" target="_blank">Blog</a>
                </li>
                <li qui-footer-column-list-item>
                  <a href="#" qui-footer-link rel="noopener noreferrer" target="_blank">Jobs</a>
                </li>
                <li qui-footer-column-list-item>
                  <a href="#" qui-footer-link rel="noopener noreferrer" target="_blank">Press</a>
                </li>
              </ul>
            </div>
            <div qui-footer-column>
              <h3 qui-footer-heading>Support</h3>
              <ul qui-footer-column-list>
                <li qui-footer-column-list-item>
                  <a href="#" qui-footer-link rel="noopener noreferrer" target="_blank">Pricing</a>
                </li>
                <li qui-footer-column-list-item>
                  <a href="#" qui-footer-link rel="noopener noreferrer" target="_blank">Documentation</a>
                </li>
                <li qui-footer-column-list-item>
                  <a href="#" qui-footer-link rel="noopener noreferrer" target="_blank">Guides</a>
                </li>
                <li qui-footer-column-list-item>
                  <a href="#" qui-footer-link rel="noopener noreferrer" target="_blank">API Status</a>
                </li>
              </ul>
            </div>
            <div qui-footer-column>
              <h3 qui-footer-heading>Product</h3>
              <ul qui-footer-column-list>
                <li qui-footer-column-list-item>
                  <a href="#" qui-footer-link rel="noopener noreferrer" target="_blank">Features</a>
                </li>
                <li qui-footer-column-list-item>
                  <a href="#" qui-footer-link rel="noopener noreferrer" target="_blank">Integrations</a>
                </li>
                <li qui-footer-column-list-item>
                  <a href="#" qui-footer-link rel="noopener noreferrer" target="_blank">Pricing</a>
                </li>
                <li qui-footer-column-list-item>
                  <a href="#" qui-footer-link rel="noopener noreferrer" target="_blank">Examples</a>
                </li>
              </ul>
            </div>
          </div>
          <div qui-footer-section>
            <h3 qui-footer-heading>Newsletter</h3>
            <p qui-text size="sm" color="muted">
              Join our newsletter to stay up to date on features and releases.
            </p>
            <div qui-stack align="start" direction="row" gap="lg">
              <label qui-sr-only for="email-address">Email address</label>
              <input
                qui-input
                autocomplete="email"
                id="email-address"
            ...
            <p qui-text size="xs" color="muted">
                By subscribing you agree to with our
                <a qui-link href="#">Privacy Policy</a>
                and provide consent to receive updates from our company.
              </p>
            </div>
          </div>
        </div>
        <div qui-footer-banner>
          <nav qui-footer-banner-list>
            <p qui-footer-copyright>© 2020 Your Company, Inc. All rights reserved.</p>
            <a qui-footer-link href="#">Privacy Policy</a>
            <a qui-footer-link href="#">Terms of Service</a>
            <a qui-footer-link href="#">Cookies</a>
          </nav>
          <ul qui-footer-banner-list>
            <li qui-footer-banner-list-item>
              <a qui-footer-link href="#" style="display: flex; align-items: center; color: var(--color-muted-fg);">
                <span qui-sr-only>Facebook</span>
            ...
            <li qui-footer-banner-list-item>
              <a qui-footer-link href="#" style="display: flex; align-items: center; color: var(--color-muted-fg);">
                <span qui-sr-only>Instagram</span>
            ...
            <li qui-footer-banner-list-item>
              <a qui-footer-link href="#" style="display: flex; align-items: center; color: var(--color-muted-fg);">
                <span qui-sr-only>LinkedIn</span>
...
export const WithColumns: Story = Default;
      ...
      <footer qui-footer>
        <div qui-footer-content>
          <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: var(--spacing-4);">
            ...
            <ul style="display: flex; gap: var(--spacing-4); list-style: none; margin: 0; padding: 0;">
              <li><a qui-footer-link href="#" style="display: flex; align-items: center; color: var(--color-muted-fg);"><span qui-sr-only>Facebook</span><svg style="height: var(--spacing-5); width: var(--spacing-5);" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd"/></svg></a></li>
              <li><a qui-footer-link href="#" style="display: flex; align-items: center; color: var(--color-muted-fg);"><span qui-sr-only>Instagram</span><svg style="height: var(--spacing-5); width: var(--spacing-5);" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.067.06 1.407.06 4.123v.08c0 2.643-.012 2.987-.06 4.043-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.067.048-1.407.06-4.123.06h-.08c-2.643 0-2.987-.012-4.043-.06-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.047-1.024-.06-1.379-.06-3.808v-.63c0-2.43.013-2.784.06-3.808.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772A4.902 4.902 0 015.45 2.525c.636-.247 1.363-.416 2.427-.465C8.901 2.013 9.256 2 11.685 2h.63zm-.081 1.802h-.468c-2.456 0-2.784.011-3.807.058-.975.045-1.504.207-1.857.344-.467.182-.8.398-1.15.748-.35.35-.566.683-.748 1.15-.137.353-.3.882-.344 1.857-.047 1.023-.058 1.351-.058 3.807v.468c0 2.456.011 2.784.058 3.807.045.975.207 1.504.344 1.857.182.466.399.8.748 1.15.35.35.683.566 1.15.748.353.137.882.3 1.857.344 1.054.048 1.37.058 4.041.058h.08c2.597 0 2.917-.01 3.96-.058.976-.045 1.505-.207 1.858-.344.466-.182.8-.398 1.15-.748.35-.35.566-.683.748-1.15.137-.353.3-.882.344-1.857.048-1.055.058-1.37.058-4.041v-.08c0-2.597-.01-2.917-.058-3.96-.045-.976-.207-1.505-.344-1.858a3.097 3.097 0 00-.748-1.15 3.098 3.098 0 00-1.15-.748c-.353-.137-.882-.3-1.857-.344-1.023-.047-1.351-.058-3.807-.058zM12 6.865a5.135 5.135 0 110 10.27 5.135 5.135 0 010-10.27zm0 1.802a3.333 3.333 0 100 6.666 3.333 3.333 0 000-6.666zm5.338-3.205a1.2 1.2 0 110 2.4 1.2 1.2 0 010-2.4z" clip-rule="evenodd"/></svg></a></li>
              <li><a qui-footer-link href="#" style="display: flex; align-items: center; color: var(--color-muted-fg);"><span qui-sr-only>X</span><svg style="height: var(--spacing-5); width: var(--spacing-5);" fill="currentColor" viewBox="0 0 300 271" aria-hidden="true"><path d="M236 0h46L181 115l118 156h-92.6l-72.5-94.8-83 94.8h-46l107-123L-1.1 0h94.9l65.5 86.6L236 0zm-16.1 244h25.5L80.4 26H53l166.9 218z"/></svg></a></li>
              <li><a qui-footer-link href="#" style="display: flex; align-items: center; color: var(--color-muted-fg);"><span qui-sr-only>LinkedIn</span><svg style="height: var(--spacing-5); width: var(--spacing-5);" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path fill-rule="nonzero" d="M19 0H5a5 5 0 00-5 5v14a5 5 0 005 5h14a5 5 0 005-5V5a5 5 0 00-5-5zM8 19H5V8h3v11zM6.5 6.732c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zM20 19h-3v-5.604c0-3.368-4-3.113-4 0V19h-3V8h3v1.765c1.396-2.586 7-2.777 7 2.476V19z"/></svg></a></li>
              <li><a qui-footer-link href="#" style="display: flex; align-items: center; color: var(--color-muted-fg);"><span qui-sr-only>YouTube</span><svg style="height: var(--spacing-5); width: var(--spacing-5);" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.746 22 12 22 12s0 3.255-.418 4.814a2.504 2.504 0 0 1-1.768 1.768c-1.56.419-7.814.419-7.814.419s-6.255 0-7.814-.419a2.505 2.505 0 0 1-1.768-1.768C2 15.255 2 12 2 12s0-3.255.417-4.814a2.507 2.507 0 0 1 1.768-1.768C5.744 5 11.998 5 11.998 5s6.255 0 7.814.418ZM15.194 12 10 15V9l5.194 3Z" clip-rule="evenodd"/></svg></a></li>
            </ul>
          </div>
        </div>
        <div qui-footer-banner>
          <p qui-footer-copyright>© 2020 Pulse Analytics, Inc. All rights reserved.</p>
        </div>
      </footer>
    `,
  }),
