  ...
  render: (args) => ({
    ...
    template: `
      <header style="width: 100vw; display: flex; flex-direction: column; align-items: center;">
        <nav pui-navigation-menu style="width: 100%;">
          <div pui-navigation-menu-brand>
            <a pui-navigation-menu-logo aria-label="Your company">
          ...
          <div pui-navigation-menu-items>
            <a pui-button variant="ghost" size="sm" href="#"> Home </a>
            <a pui-button variant="ghost" size="sm" href="#"> Link Two </a>
            <a pui-button variant="ghost" size="sm" pui-navigation-menu-dropdown-trigger [cdkMenuTriggerFor]="dropdown">
              Dropdown
              <pui-navigation-menu-dropdown-indicator></pui-navigation-menu-dropdown-indicator>
            </a>
            <ng-template #dropdown>
              <div pui-navigation-menu-dropdown-content>
                <ol pui-navigation-menu-dropdown-group>
                  <li pui-navigation-menu-dropdown-item>
                    <button pui-button variant="ghost" size="sm" fullWidth="true">Item One</button>
                  </li>
                  <li pui-navigation-menu-dropdown-item>
                    <button pui-button variant="ghost" size="sm" fullWidth="true">Item Two</button>
                  </li>
                  <li pui-navigation-menu-dropdown-item>
                    <button pui-button variant="ghost" size="sm" fullWidth="true">Item Three</button>
                  </li>
                </ol>
              </div>
            </ng-template>
            <div pui-navigation-menu-actions>
              <a pui-button variant="ghost" size="sm" href="#release-notes">
              ...
              <a pui-button variant="ghost" size="sm" href="#settings">
              ...
              <a pui-button variant="ghost" size="sm" href="#help"> Help </a>
              <a pui-button variant="ghost" size="sm"  href="#sign-out">
