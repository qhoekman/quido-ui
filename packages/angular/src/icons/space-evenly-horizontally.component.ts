...
@Component({
  selector:
    '[qui-icon][name="space-evenly-horizontally"], [qui-icon-space-evenly-horizontally]',
  standalone: true,
  template: `<svg
    width="15"
    height="15"
...
export class IconSpaceEvenlyHorizontallyComponent extends IconComponent {
  override name = 'space-evenly-horizontally';
}
