...
@Component({
  selector:
    '[qui-icon][name="text-align-bottom"], [qui-icon-text-align-bottom]',
  standalone: true,
  template: `<svg
    width="15"
    height="15"
...
export class IconTextAlignBottomComponent extends IconComponent {
  override name = 'text-align-bottom';
}
