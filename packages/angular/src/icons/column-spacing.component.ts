...
@Component({
  selector: '[qui-icon][name="column-spacing"], [qui-icon-column-spacing]',
  standalone: true,
  template: `<svg
    width="15"
    height="15"
...
export class IconColumnSpacingComponent extends IconComponent {
  override name = 'column-spacing';
}
