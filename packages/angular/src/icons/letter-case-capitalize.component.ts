...
@Component({
  selector:
    '[qui-icon][name="letter-case-capitalize"], [qui-icon-letter-case-capitalize]',
  standalone: true,
  template: `<svg
    width="15"
    height="15"
...
export class IconLetterCaseCapitalizeComponent extends IconComponent {
  override name = 'letter-case-capitalize';
}
