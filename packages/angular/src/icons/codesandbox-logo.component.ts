...
@Component({
  selector: '[qui-icon][name="codesandbox-logo"], [qui-icon-codesandbox-logo]',
  standalone: true,
  template: `<svg
    width="15"
    height="15"
...
export class IconCodesandboxLogoComponent extends IconComponent {
  override name = 'codesandbox-logo';
}
