...
@Component({
  selector:
    '[qui-icon][name="letter-case-toggle"], [qui-icon-letter-case-toggle]',
  standalone: true,
  template: `<svg
    width="15"
    height="15"
...
export class IconLetterCaseToggleComponent extends IconComponent {
  override name = 'letter-case-toggle';
}
