...
2. **Install packages**: The design system is built using a number of different packages. You can install them using the following command:
...
3. **Class Merger**: To reduce the number of duplicate classes in the final CSS output, we use the `tailwind-merge` package. So, you need to create a utility function that merges classes:
