...
- **Consistency**: The design system should provide a consistent look and feel across all applications. This is doen using the design tokens described in the CSS file.
