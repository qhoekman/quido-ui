...
import NavbarBrandComponent from "./navbar-brand.vue";
import NavbarLogoComponent from "./navbar-logo.vue";
import NavbarItemsComponent from "./navbar-items.vue";
import NavbarLinkComponent from "./navbar-link.vue";
import NavbarDropdownComponent from "./navbar-dropdown.vue";
import NavbarDropdownTriggerComponent from "./navbar-dropdown-trigger.vue";
import NavbarDropdownContentComponent from "./navbar-dropdown-content.vue";
import NavbarDropdownLinkComponent from "./navbar-dropdown-link.vue";
import NavbarActionsComponent from "./navbar-actions.vue";
import ButtonComponent from "../button/button.vue";
import InputComponent from "../input/input.vue";
import DropdownMenuGroupComponent from "../dropdown-menu/dropdown-menu-group.vue";
import MegaMenuComponent from "../mega-menu/mega-menu.vue";
import MegaMenuListComponent from "../mega-menu/mega-menu-list.vue";
import MegaMenuItemComponent from "../mega-menu/mega-menu-item.vue";
import MegaMenuTriggerComponent from "../mega-menu/mega-menu-trigger.vue";
import MegaMenuContentComponent from "../mega-menu/mega-menu-content.vue";
import MegaMenuLinkComponent from "../mega-menu/mega-menu-link.vue";
import MegaMenuListItemComponent from "../mega-menu/mega-menu-list-item.vue";
...
const meta = {
  ...
  render: (args) => ({
    components: {
      ...
      NavbarDropdownTriggerComponent,
      NavbarDropdownContentComponent,
    ...
    template: `
      <NavbarComponent v-bind="args">
        <NavbarBrandComponent>
          <NavbarLogoComponent aria-label="Your company" href="#">
            <svg
              viewBox="0 0 167 41"
              style="height: var(--spacing-8); width: auto; fill: var(--color-background-fg);"
            >
              <path
                fill-rule="nonzero"
                d="M48.631 28.794h11.952v-3.6h-7.704v-13.56h-4.248v17.16zM67.664 26.394c-1.704 0-2.592-1.488-2.592-3.72s.888-3.744 2.592-3.744c1.704 0 2.616 1.512 2.616 3.744s-.912 3.72-2.616 3.72zm.024 2.784c3.96 0 6.552-2.808 6.552-6.504 0-3.696-2.592-6.504-6.552-6.504-3.936 0-6.576 2.808-6.576 6.504 0 3.696 2.64 6.504 6.576 6.504zM81.094 33.042c1.824 0 3.432-.408 4.512-1.368.984-.888 1.632-2.232 1.632-4.08V16.506h-3.744v1.32h-.048c-.72-1.032-1.824-1.68-3.456-1.68-3.048 0-5.16 2.544-5.16 6.144 0 3.768 2.568 5.832 5.328 5.832 1.488 0 2.424-.6 3.144-1.416h.096v1.224c0 1.488-.696 2.352-2.352 2.352-1.296 0-1.944-.552-2.16-1.2h-3.792c.384 2.568 2.616 3.96 6 3.96zm-.024-7.824c-1.464 0-2.424-1.2-2.424-3.048 0-1.872.96-3.072 2.424-3.072 1.632 0 2.496 1.392 2.496 3.048 0 1.728-.792 3.072-2.496 3.072zM94.937 26.394c-1.704 0-2.592-1.488-2.592-3.72s.888-3.744 2.592-3.744c1.704 0 2.616 1.512 2.616 3.744s-.912 3.72-2.616 3.72zm.024 2.784c3.96 0 6.552-2.808 6.552-6.504 0-3.696-2.592-6.504-6.552-6.504-3.936 0-6.576 2.808-6.576 6.504 0 3.696 2.64 6.504 6.576 6.504zM102.655 28.794h3.912V16.506h-3.912v12.288zm0-13.992h3.912v-3.168h-3.912v3.168zM108.264 32.85h3.912v-5.328h.048c.768 1.032 1.896 1.656 3.48 1.656 3.216 0 5.352-2.544 5.352-6.528 0-3.696-1.992-6.504-5.256-6.504-1.68 0-2.88.744-3.72 1.848h-.072v-1.488h-3.744V32.85zm6.432-6.696c-1.68 0-2.64-1.368-2.64-3.36 0-1.992.864-3.504 2.568-3.504 1.68 0 2.472 1.392 2.472 3.504 0 2.088-.912 3.36-2.4 3.36zM127.426 29.178c3.216 0 5.592-1.392 5.592-4.08 0-3.144-2.544-3.696-4.704-4.056-1.56-.288-2.952-.408-2.952-1.272 0-.768.744-1.128 1.704-1.128 1.08 0 1.824.336 1.968 1.44h3.6c-.192-2.424-2.064-3.936-5.544-3.936-2.904 0-5.304 1.344-5.304 3.936 0 2.88 2.28 3.456 4.416 3.816 1.632.288 3.12.408 3.12 1.512 0 .792-.744 1.224-1.92 1.224-1.296 0-2.112-.6-2.256-1.824h-3.696c.12 2.712 2.376 4.368 5.976 4.368zM138.331 29.154c1.704 0 2.784-.672 3.672-1.872h.072v1.512h3.744V16.506h-3.912v6.864c0 1.464-.816 2.472-2.16 2.472-1.248 0-1.848-.744-1.848-2.088v-7.248h-3.888v8.064c0 2.736 1.488 4.584 4.32 4.584zM147.521 28.794h3.912v-6.888c0-1.464.72-2.496 1.944-2.496 1.176 0 1.728.768 1.728 2.088v7.296h3.912v-6.888c0-1.464.696-2.496 1.944-2.496 1.176 0 1.728.768 1.728 2.088v7.296h3.912v-7.992c0-2.76-1.392-4.656-4.176-4.656-1.584 0-2.904.672-3.864 2.16h-.048c-.624-1.32-1.848-2.16-3.456-2.16-1.776 0-2.952.84-3.72 2.112h-.072v-1.752h-3.744v12.288z"
        ...
        <NavbarItemsComponent>
          <template v-for="item in navigation" :key="item.name">
            <NavbarDropdownComponent v-if="item.dropdown">
              <NavbarDropdownTriggerComponent>{{ item.name }}</NavbarDropdownTriggerComponent>
              <NavbarDropdownContentComponent>
                <DropdownMenuGroupComponent>
                  <NavbarDropdownLinkComponent
            ...
            <NavbarLinkComponent v-else :href="item.href">
              {{ item.name }}
            </NavbarLinkComponent>
          </template>
        </NavbarItemsComponent>
...
export const WithMenuLeft: Story = {
  render: (args) => ({
    components: {
      NavbarComponent,
      NavbarBrandComponent,
    ...
    template: `
      <NavbarComponent v-bind="args">
        <NavbarBrandComponent style="flex: none; margin-right: var(--spacing-6);">
          <NavbarLogoComponent aria-label="Your company" href="#">
            <svg
              viewBox="0 0 167 41"
              style="height: var(--spacing-8); width: auto; fill: var(--color-background-fg);"
...
export const WithMenuRight: Story = {
  render: () => ({
    components: {
      NavbarComponent,
      NavbarBrandComponent,
    ...
    setup() {
      return { navigation, logoSvg: COMPANY_LOGO_SVG };
    },
    template: `
      <NavbarComponent>
        <NavbarBrandComponent>
          <NavbarLogoComponent aria-label="Your company" href="#">
            <svg viewBox="0 0 167 41" style="height: var(--spacing-8); width: auto; fill: var(--color-background-fg);" v-html="logoSvg"></svg>
          </NavbarLogoComponent>
        </NavbarBrandComponent>
        <NavbarItemsComponent>
          <template v-for="item in navigation" :key="item.name">
...
export const WithMenuCenter: Story = {
  render: () => ({
    components: {
      NavbarComponent,
      NavbarBrandComponent,
...
export const WithLogoCenter: Story = {
  render: () => ({
    components: {
      NavbarComponent,
      NavbarBrandComponent,
    ...
    template: `
      <NavbarComponent>
        <NavbarItemsComponent style="width: 400px;">
          <template v-for="item in navigation" :key="item.name">
            <NavbarDropdownComponent v-if="item.dropdown">
              <NavbarDropdownTriggerComponent>{{ item.name }}</NavbarDropdownTriggerComponent>
              <NavbarDropdownContentComponent>
        ...
        <NavbarBrandComponent style="flex: none;">
          <NavbarLogoComponent aria-label="Your company" href="#">
            <svg viewBox="0 0 167 41" style="height: var(--spacing-8); width: auto; fill: var(--color-background-fg);" v-html="logoSvg"></svg>
          </NavbarLogoComponent>
        </NavbarBrandComponent>
        <NavbarActionsComponent style="width: 400px;">
          <ButtonComponent as-child>
            <a href="#">Learn more</a>
          </ButtonComponent>
        </NavbarActionsComponent>
  ...
  render: () => ({
    ...
    template: `
      <NavbarComponent>
        ...
        <NavbarActionsComponent style="margin-left: var(--spacing-6); justify-content: flex-start;">
          <InputComponent type="search" placeholder="Search" style="width: var(--spacing-64);" />
        </NavbarActionsComponent>
        <NavbarItemsComponent>
          <template v-for="item in navigation" :key="item.name">
            <NavbarDropdownComponent v-if="item.dropdown">
...
export const WithMegaMenu: Story = {
  render: () => ({
    ...
    setup() {
      return { logoSvg: COMPANY_LOGO_SVG };
    },
    template: `
      <NavbarComponent>
        <NavbarBrandComponent style="flex: none; margin-right: var(--spacing-6);">
        ...
        <NavbarItemsComponent style="flex: 1;">
          <MegaMenuComponent>
            <MegaMenuListComponent>
              <MegaMenuItemComponent>
                <MegaMenuTriggerComponent>Getting started</MegaMenuTriggerComponent>
                <MegaMenuContentComponent>
                  <ul style="display: grid; width: 500px; grid-template-columns: .75fr 1fr; gap: var(--spacing-3); padding: var(--spacing-4); margin: 0; list-style: none;">
                    <li style="grid-row: span 3 / span 3;">
                      <MegaMenuLinkComponent variant="plain" as-child>
                        <a href="/" style="display: flex; height: 100%; width: 100%; user-select: none; flex-direction: column; justify-content: flex-end; border-radius: var(--border-radius-md); background: linear-gradient(to bottom, rgba(0, 0, 0, 0.05), rgba(0, 0, 0, 0.1)); padding: var(--spacing-6); text-decoration: none; outline: none;">
                          <div style="margin-bottom: var(--spacing-2); margin-top: var(--spacing-4); font-size: var(--font-size-lg); font-weight: var(--font-weight-medium);">quido-ui</div>
                          <p style="font-size: var(--font-size-sm); line-height: var(--line-height-tight); color: var(--color-muted-fg); margin: 0;">
                            Beautifully designed components for React, Vue, and Angular.
                          </p>
                        </a>
                      </MegaMenuLinkComponent>
                    </li>
                    <MegaMenuListItemComponent href="/docs" title="Introduction">
                      Re-usable components shared across three frameworks.
                    </MegaMenuListItemComponent>
                    <MegaMenuListItemComponent href="/docs/installation" title="Installation">
                      How to install dependencies and structure your app.
                    </MegaMenuListItemComponent>
                    <MegaMenuListItemComponent href="/docs/theming" title="Theming">
                      Customize colors, spacing, and typography with tokens.
                    </MegaMenuListItemComponent>
                  </ul>
                </MegaMenuContentComponent>
              </MegaMenuItemComponent>
...
export const Composition: Story = {
  render: () => ({
    ...
    setup() {
      return { siteNavigation, logoSvg: COMPANY_LOGO_SVG };
    },
    template: `
      <NavbarComponent>
        <NavbarBrandComponent>
          <NavbarLogoComponent aria-label="Pulse Analytics" href="#">
            <svg viewBox="0 0 167 41" style="height: var(--spacing-8); width: auto; fill: var(--color-primary);" v-html="logoSvg"></svg>
          </NavbarLogoComponent>
        </NavbarBrandComponent>
        <NavbarItemsComponent>
          <template v-for="item in siteNavigation" :key="item.name">
            <NavbarDropdownComponent v-if="item.dropdown">
              <NavbarDropdownTriggerComponent>{{ item.name }}</NavbarDropdownTriggerComponent>
              <NavbarDropdownContentComponent>
                <DropdownMenuGroupComponent>
