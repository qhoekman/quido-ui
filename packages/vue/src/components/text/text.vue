...
const classes = computed(() => {
  // If variant is set and not 'unset', only apply variant class
  ...
  // Otherwise, apply size, weight, and color (always include them, even if 'unset')
  return textVariants({
    variant: "unset",
    size: props.size,
    weight: props.weight,
