import NavigationMenuComponent from "@/components/navigation-menu/navigation-menu.vue";
import NavigationMenuBrandComponent from "@/components/navigation-menu/navigation-menu-brand.vue";
import NavigationMenuLogoComponent from "@/components/navigation-menu/navigation-menu-logo.vue";
import NavigationMenuItemsComponent from "@/components/navigation-menu/navigation-menu-items.vue";
import NavigationMenuLinkComponent from "@/components/navigation-menu/navigation-menu-link.vue";
import NavigationMenuActionsComponent from "@/components/navigation-menu/navigation-menu-actions.vue";
  ...
  render: (args) => ({
    ...
    template: `
      <header style="width: 100vw; display: flex; flex-direction: column; align-items: center;">
        <NavigationMenuComponent v-bind="args" style="width: 100%;">
          <NavigationMenuBrandComponent>
            <NavigationMenuLogoComponent aria-label="Your company" href="#">
          ...
          <NavigationMenuItemsComponent>
            <ButtonComponent variant="ghost" size="sm" as="a" href="#"> Home </ButtonComponent>
            <ButtonComponent variant="ghost" size="sm" as="a" href="#"> Pricing </ButtonComponent>
            <NavigationMenuActionsComponent>
              <ButtonComponent variant="ghost" size="sm" as="a" href="#release-notes">
              ...
              <ButtonComponent variant="ghost" size="sm" as="a" href="#settings">
              ...
              <ButtonComponent variant="ghost" size="sm" as="a" href="#help"> Help </ButtonComponent>
              <ButtonComponent variant="ghost" size="sm" as="a" href="#sign-out">
...
} satisfies Meta<typeof NavigationMenuComponent>;
  ...
  render: () => ({
    ...
    template: `
      <div style="width: 100%; border: var(--border-width-default) solid var(--color-border); border-radius: var(--border-radius-lg); overflow: hidden;">
        <NavigationMenuComponent style="width: 100%; padding: var(--spacing-3) var(--spacing-4); border-bottom: var(--border-width-default) solid var(--color-border);">
          <NavigationMenuBrandComponent>
          ...
          <NavigationMenuItemsComponent>
            <ButtonComponent variant="ghost" size="sm" as="a" href="#"> Home </ButtonComponent>
            <ButtonComponent variant="ghost" size="sm" as="a" href="#"> Pricing </ButtonComponent>
            <ButtonComponent variant="primary" size="sm" as="a" href="#"> Sign up </ButtonComponent>
          </NavigationMenuItemsComponent>
        </NavigationMenuComponent>
