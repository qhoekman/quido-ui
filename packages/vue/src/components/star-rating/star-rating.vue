...
const starVariants = cva("q-star-rating-star", {
  variants: {
    filled: {
      true: "variant--filled",
...
export type StarRatingVariants = VariantProps<typeof starVariants>;
...
const totalStars = computed(() => {
  return Array.from({ length: props.stars }, (_, i) => i + 1);
});
...
.q-star-rating-star.variant--filled {
  fill: var(--color-yellow-500);
  color: var(--color-yellow-500);
}

.q-star-rating-star.variant--unfilled {
