...
test.describe('Radio Card', () => {
  test('Default story renders 5 items with the default value checked and xs disabled, no console errors', async ({
    ...
    await page.goto('http://localhost:6006/?path=/story/features-ecommerce-components-radio-card--default')
  ...
  test('disabled prop prevents interaction with all items', async ({ page }) => {
    await page.goto(
      'http://localhost:6006/?path=/story/features-ecommerce-components-radio-card--default&args=disabled:true'
    )
    const frame = page.frameLocator('#storybook-preview-iframe')
  ...
  test('Large story renders items with descriptions, and clicking the enabled item selects it', async ({
    ...
    await page.goto('http://localhost:6006/?path=/story/features-ecommerce-components-radio-card--large')
    const frame = page.frameLocator('#storybook-preview-iframe')
