...
test.describe('Tag Input', () => {
  test('Default story renders pre-filled tags, no console errors', async ({ page }) => {
    ...
    await page.goto('http://localhost:6006/?path=/story/components-data-entry-tag-input--default')
  ...
  test('pressing Enter adds a tag and clears the input', async ({ page }) => {
    await page.goto('http://localhost:6006/?path=/story/components-data-entry-tag-input--empty')
    const frame = page.frameLocator('#storybook-preview-iframe')
  ...
  test('clicking a tag remove button removes only that tag', async ({ page }) => {
    await page.goto(
      'http://localhost:6006/?path=/story/components-data-entry-tag-input--with-many-tags'
    )
    const frame = page.frameLocator('#storybook-preview-iframe')
    const tags = frame.getByTestId('qui-tag-input-tag')
  ...
  test('Disabled story disables the input', async ({ page }) => {
    await page.goto('http://localhost:6006/?path=/story/components-data-entry-tag-input--disabled')
    const frame = page.frameLocator('#storybook-preview-iframe')
