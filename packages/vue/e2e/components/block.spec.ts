...
test.describe('Block', () => {
  test('Default renders with base styling, no inset margin or outline border', async ({ page }) => {
    ...
    await page.goto('http://localhost:6006/?path=/story/features-mobile-components-block--default')
  ...
  test('WithInset applies inset margin', async ({ page }) => {
    await page.goto('http://localhost:6006/?path=/story/features-mobile-components-block--with-inset')
    const frame = page.frameLocator('#storybook-preview-iframe')
    const block = frame.locator('.q-block')
  ...
  test('WithOutline applies inset margin and a visible border', async ({ page }) => {
    await page.goto('http://localhost:6006/?path=/story/features-mobile-components-block--with-outline')
    const frame = page.frameLocator('#storybook-preview-iframe')
    const block = frame.locator('.q-block')
