...
test.describe('Select', () => {
  test('Default story renders a closed trigger with the placeholder, no console errors', async ({
    ...
    await page.goto('http://localhost:6006/?path=/story/components-data-entry-select--default')
  ...
  test('WithDefaultValue story pre-selects the given value', async ({ page }) => {
    await page.goto(
      'http://localhost:6006/?path=/story/components-data-entry-select--with-default-value'
    )
    const frame = page.frameLocator('#storybook-preview-iframe')
  ...
  test('Disabled story cannot be opened', async ({ page }) => {
    await page.goto('http://localhost:6006/?path=/story/components-data-entry-select--disabled')
    const frame = page.frameLocator('#storybook-preview-iframe')
    const trigger = frame.getByRole('combobox')
  ...
  test('WithGroups story shows grouped options separated by a separator', async ({ page }) => {
    await page.goto('http://localhost:6006/?path=/story/components-data-entry-select--with-groups')
    const frame = page.frameLocator('#storybook-preview-iframe')
    const trigger = frame.getByRole('combobox')
  ...
  test('Sizes story renders three differently sized triggers', async ({ page }) => {
    await page.goto('http://localhost:6006/?path=/story/components-data-entry-select--sizes')
    const frame = page.frameLocator('#storybook-preview-iframe')
