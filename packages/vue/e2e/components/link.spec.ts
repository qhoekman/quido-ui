...
test.describe('Link', () => {
  test('Default story renders an anchor with correct href and text, no console errors', async ({
    ...
    await page.goto('http://localhost:6006/?path=/story/components-navigation-link--default')
  ...
  test('Internal story renders a relative href', async ({ page }) => {
    await page.goto('http://localhost:6006/?path=/story/components-navigation-link--internal')
    const frame = page.frameLocator('#storybook-preview-iframe')
  ...
  test('MultipleLinks story renders 3 independent links', async ({ page }) => {
    await page.goto(
      'http://localhost:6006/?path=/story/components-navigation-link--multiple-links'
    )
    const frame = page.frameLocator('#storybook-preview-iframe')
