...
test.describe('QR Code', () => {
  test('Default story renders a valid QR code image, no console errors', async ({ page }) => {
    ...
    await page.goto('http://localhost:6006/?path=/story/components-navigation-qr-code--default')
  ...
  test('CustomValue and LongValue stories render distinct QR codes', async ({ page }) => {
    ...
    await page.goto(
      'http://localhost:6006/?path=/story/components-navigation-qr-code--custom-value'
    )
    ...
    await page.goto('http://localhost:6006/?path=/story/components-navigation-qr-code--long-value')
