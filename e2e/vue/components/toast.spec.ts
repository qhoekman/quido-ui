...
test.describe('Toast', () => {
  ...
  test('Destructive story applies the destructive variant class', async ({ page }) => {
    await page.goto('?path=/story/components-feedback-toast--destructive')
    const frame = page.frameLocator('#storybook-preview-iframe')
  ...
  test('WithoutDescription story omits the description', async ({ page }) => {
    await page.goto(
      '?path=/story/components-feedback-toast--without-description'
    )
    const frame = page.frameLocator('#storybook-preview-iframe')
  ...
  test('WithoutAction story omits the action button', async ({ page }) => {
    await page.goto('?path=/story/components-feedback-toast--without-action')
    const frame = page.frameLocator('#storybook-preview-iframe')
