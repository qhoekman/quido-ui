...
1. **Configure Design Tokens**: The design tokens are configured in the `index.css` file. For the components to work we recommend the following configuration:
...
@layer base {
  ...
  :root {
    ...
    --border-width-4: 4px;
    --border-width-8: 8px;
    --box-shadow-sm: 0 1px 2px 0 rgb(0 0 0 / 5%);
    --box-shadow-default: 0 1px 3px 0 rgb(0 0 0 / 10%), 0 1px 2px -1px rgb(0 0
            0 / 10%);
    --box-shadow-md: 0 4px 6px -1px rgb(0 0 0 / 10%), 0 2px 4px -2px rgb(0 0 0 /
            10%);
    --box-shadow-lg: 0 10px 15px -3px rgb(0 0 0 / 10%), 0 4px 6px -4px rgb(0 0
            0 / 10%);
    --box-shadow-xl: 0 20px 25px -5px rgb(0 0 0 / 10%), 0 8px 10px -6px rgb(0 0
            0 / 10%);
    --box-shadow-2xl: 0 25px 50px -12px rgb(0 0 0 / 25%);
    --box-shadow-inner: inset 0 2px 4px 0 rgb(0 0 0 / 5%);
    ...
    --spacing-px: 1px;
    --spacing-0: 0px;
    --spacing-0-1: 0.0625rem;
    --spacing-0-2: 0.125rem;
    --spacing-0-3: 0.1875rem;
    --spacing-0-4: 0.25rem;
  ...
  * {
  ...
  @media (prefers-color-scheme: light) {
    :root {
      ...
      --color-secondary-fg: var(--color-gray-50);
      --color-danger: var(--color-red-500);
      --color-danger-fg: var(--color-gray-50);
      --color-background: var(--color-white);
      --color-background-fg: var(--color-gray-950);
      --color-border: var(--color-gray-200);
      --color-input: var(--color-white);
      --color-input-fg: var(--color-gray-900);
      --color-muted: var(--color-gray-100);
      --color-muted-fg: var(--color-gray-700);
      --color-card: var(--color-gray-50);
      --color-card-fg: var(--color-gray-900);
      --color-popover: var(--color-gray-50);
      --color-popover-fg: var(--color-gray-900);
      --color-ring: var(--color-blue-500);
      --color-sidebar: var(--color-gray-50);
      --color-sidebar-fg: var(--color-gray-900);
      --color-sidebar-primary: var(--color-blue-500);
      --color-sidebar-primary-fg: var(--color-gray-50);
      --color-sidebar-accent: var(--color-gray-200);
      --color-sidebar-accent-fg: var(--color-gray-900);
      --color-sidebar-border: var(--color-gray-200);
      --color-sidebar-ring: var(--color-blue-500);
      --color-chart: var(--color-gray-900);
      --color-chart-fg: var(--color-gray-50);
    }
  }
  ...
  @media (prefers-color-scheme: dark) {
    :root {
      ...
      --color-primary-fg: var(--color-gray-900);
      --color-secondary: var(--color-purple-300);
      --color-secondary-fg: var(--color-gray-900);
      --color-danger: var(--color-red-300);
      --color-danger-fg: var(--color-gray-950);
      --color-background: var(--color-gray-900);
      --color-background-fg: var(--color-gray-50);
      ...
      --color-card-fg: var(--color-gray-50);
      --color-popover: var(--color-gray-800);
      --color-popover-fg: var(--color-gray-50);
      --ring: var(--color-blue-300);
      --color-sidebar: var(--color-gray-800);
      --color-sidebar-fg: var(--color-gray-50);
      --color-sidebar-primary: var(--color-blue-500);
      --color-sidebar-primary-fg: var(--color-gray-50);
      --color-sidebar-accent: var(--color-gray-700);
      --color-sidebar-accent-fg: var(--color-gray-50);
      --color-sidebar-border: var(--color-gray-700);
      --color-sidebar-ring: var(--color-blue-300);
      --color-chart: var(--color-gray-900);
      --color-chart-fg: var(--color-gray-50);
    }
  }
